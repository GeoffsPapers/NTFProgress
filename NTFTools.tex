...
languages, and correspondingly have monomorphic (NX0, NH0) and polymorphic (NX1, NH1) variants.
...
The {\tt \$domains} property specifies restrictions on the quantification domain across the 
accessibility relation \cite{FM98}.
...
\begin{verbatim}
    8 (   2   ~;   0   |;   1   &)
      ...
      (   4 {}@;   0 {#};   0 {.})
\end{verbatim}
\ldots~i.e., four non-classical connectives in the full form, none are indexed, and no
non-classical connectives in the short form.
